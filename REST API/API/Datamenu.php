...
class Datamenu extends REST_Controller
{
    ...
    public function index_post()
    {
        ...
        if( $this->menu->createddatamenu($data) > 0){
            $this->response([
                'status' => TRUE,
                'message' => 'kos baru telah ditambahkan.'
    ...
    public function index_put()
    {
        ...
        if( $this->menu->updatedatamenu($data, $id_kos) > 0){
            $this->response([
                'status' => TRUE,
                'message' => 'data kos telah di update.'
            ], REST_Controller::HTTP_OK);
        } else {
            //id not found
            $this->response([
